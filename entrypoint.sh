...
UUID=${UUID:-'947484d7-129b-455c-8435-ceae96d1b5b0'}
VMESS_WSPATH=${VMESS_WSPATH:-'/947484d7-129b-455c-8435-ceae96d1b5b0-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/947484d7-129b-455c-8435-ceae96d1b5b0-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/947484d7-129b-455c-8435-ceae96d1b5b0-trojan'}
SS_WSPATH=${SS_WSPATH:-'/947484d7-129b-455c-8435-ceae96d1b5b0-shadowsocks'}
